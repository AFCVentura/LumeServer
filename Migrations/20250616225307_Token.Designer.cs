...
namespace LumeServer.Migrations
{
    ...
    [Migration("20250616225307_Token")]
    partial class Token
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LumeServer.Models.User.PasswordResetToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LumeServer.Models.User.UserDailyProfileProductionCountry", b =>
                {
                    b.Property<int>("ProductionCountryId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ProductionCountryId", "UserDailyProfileId");

                    b.HasIndex("UserDailyProfileId");

                    b.ToTable("UserDailyProfileProductionCountries");
                });

            modelBuilder.Entity("LumeServer.Models.User.UserDailyProfileSpokenLanguage", b =>
                {
                    b.Property<int>("SpokenLanguageId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("SpokenLanguageId", "UserDailyProfileId");

                    b.HasIndex("UserDailyProfileId");

                    b.ToTable("UserDailyProfileSpokenLanguages");
                });
            ...
            modelBuilder.Entity("LumeServer.Models.User.UserGeneralProfileProductionCountry", b =>
                {
                    b.Property<int>("ProductionCountryId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("ProductionCountryId", "UserId");

                    b.HasIndex("UserId");

                    b.ToTable("UserGeneralProfileProductionCountries");
                });

            modelBuilder.Entity("LumeServer.Models.User.UserGeneralProfileSpokenLanguage", b =>
                {
                    b.Property<int>("SpokenLanguageId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("SpokenLanguageId", "UserId");

                    b.HasIndex("UserId");

                    b.ToTable("UserGeneralProfileSpokenLanguages");
                });
            ...
            modelBuilder.Entity("LumeServer.Models.User.UserDailyProfileProductionCountry", b =>
                {
                    b.HasOne("LumeServer.Models.Movie.ProductionCountry", "ProductionCountry")
                        .WithMany("UserDailyProfileProductionCountries")
                        .HasForeignKey("ProductionCountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LumeServer.Models.User.UserDailyProfileSpokenLanguage", b =>
                {
                    b.HasOne("LumeServer.Models.Movie.SpokenLanguage", "SpokenLanguage")
                        .WithMany("UserDailyProfileSpokenLanguages")
                        .HasForeignKey("SpokenLanguageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LumeServer.Models.User.UserGeneralProfileProductionCountry", b =>
                {
                    b.HasOne("LumeServer.Models.Movie.ProductionCountry", "ProductionCountry")
                        .WithMany("UserGeneralProfileProductionCountries")
                        .HasForeignKey("ProductionCountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LumeServer.Models.User.User", "User")
                        .WithMany("GeneralProfileProductionCountries")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LumeServer.Models.User.UserGeneralProfileSpokenLanguage", b =>
                {
                    b.HasOne("LumeServer.Models.Movie.SpokenLanguage", "SpokenLanguage")
                        .WithMany("UserGeneralProfileSpokenLanguages")
                        .HasForeignKey("SpokenLanguageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LumeServer.Models.User.User", "User")
                        .WithMany("GeneralProfileSpokenLanguages")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LumeServer.Models.Movie.ProductionCountry", b =>
                {
                    ...
                    b.Navigation("UserDailyProfileProductionCountries");

                    b.Navigation("UserGeneralProfileProductionCountries");
                });
            ...
            modelBuilder.Entity("LumeServer.Models.Movie.SpokenLanguage", b =>
                {
                    ...
                    b.Navigation("UserDailyProfileSpokenLanguages");

                    b.Navigation("UserGeneralProfileSpokenLanguages");
                });
            ...
            modelBuilder.Entity("LumeServer.Models.User.User", b =>
                {
                    ...
                    b.Navigation("GeneralProfileProductionCountries");

                    b.Navigation("GeneralProfileSpokenLanguages");
