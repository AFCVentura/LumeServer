...
namespace LumeServer.Models.User
{
    ...
    public class User : IdentityUser
    {
        ...
        public ICollection<UserGeneralProfileSpokenLanguage> GeneralProfileSpokenLanguages { get; set; }
        public ICollection<UserGeneralProfileProductionCountry> GeneralProfileProductionCountries { get; set; }
